  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Konfirmasi Hapus GTK</h5>
      ...
      <div class="modal-body">
        ...
        <form action="../proses/hapus/gtk.php" method="post">
...
<!-- edit siswa -->
<div class="modal fade" id="edit-gtk" data-backdrop="static" data-keyboard="false" tabindex="-5" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Edit GTK</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="../proses/ubah/gtk.php" class="form-edit-gtk" method="post" autocomplete="off">
