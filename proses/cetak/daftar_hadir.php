<?php
  ...
  $no = 1;
  $database_data = mysqli_query($koneksi, "SELECT * FROM siswa WHERE kehadiran='Hadir' UNION SELECT * FROM gtk WHERE kehadiran='Hadir' ORDER BY nama ASC");
?>
<html lang="en">
<head>
  <meta charset="UTF-8">
  ...
  <title>Daftar Hadir Peserta Pemilihan Ketua Osis Tahun <?= date('Y') ?></title>
